...
-- dynamics_metric_insights — JSON с текстами «Daisy notices» по метрикам (читает /api/account/dynamics-insights).
-- id глобально уникальны: seed_sr_t1_* / seed_wrs_t1_*.
