...
import { MessageCircle, User, LogOut, Calendar, TrendingUp } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">Daisy {tNav('dashboard')}</h1>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              >
                ...
                <span className="hidden sm:inline text-sm sm:text-base">{tAuth('logout')}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">{t('recentSessions')}</h3>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">{t('yourProgress')}</h3>
