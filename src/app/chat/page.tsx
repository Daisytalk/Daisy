          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">Online • Personalized for you</p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-end space-x-4">
            ...
            <button
              ...
              className="w-11 h-11 bg-blue-500 text-white rounded-full flex items-center justify-center hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
